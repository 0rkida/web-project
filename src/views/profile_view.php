...
<?php if (!empty($userProfile)): ?>
    ...
    <p>Height: <?php echo htmlspecialchars($userProfile['height']); ?> cm</p>
    ...
    <!-- Profile Picture -->
    <div>
        <img src="/assets/img/user-uploads/albums/<?php echo htmlspecialchars($userProfile['profile_picture'] ?? 'default.jpg'); ?>"
             alt="Profile Picture"
             width="150">
    </div>
    ...
    <!-- Update Form (hidden by default, will be shown when 'Update Info' button is clicked) -->
    <form id="updateForm" method="GET" action="/profile/update" enctype="multipart/form-data" style="display:none;">
